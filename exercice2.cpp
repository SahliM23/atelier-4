...
#include <map>
#include <string>
#include <sstream>  //utiliser une fonction qui convertie une chaine des caracteres a un nombre
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            //format d'heure et du minute 09h:00
